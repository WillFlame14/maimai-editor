...
public class GUI extends JFrame implements ActionListener, MouseListener {
    ...
    public GUI(String name, Song song)throws IOException {
        ...
        hitarea = ImageIO.read(new File("hit_area.png")).getScaledInstance(50, 50, BufferedImage.SCALE_DEFAULT);
    ...
    public static void show(Graphics g) {
        ...
        for(ActiveNote a: activenotes) {      //active notes
            ...
            switch(a.note.type) {
                case "Single":
                    g.drawImage(singlenote, (int)p1.a, (int)p1.b, null);
                    break;
                case "Double":
                    p2 = ActiveNote.convertCartesian(a.radius, ((DoubleNote)a.note).pos2);
                    g.drawImage(doublenote, (int)p1.a, (int)p1.b, null);
                    g.drawImage(doublenote, (int)p2.a, (int)p2.b, null);
                    break;    
                case "Hold":
                    g.drawImage(holdnote, (int)p1.a, (int)p1.b, null);
                    break;
                case "DoubleHold":
                    p2 = ActiveNote.convertCartesian(a.radius, ((DoubleHoldNote)a.note).pos2);
                    g.drawImage(doubleholdnote, (int)p1.a, (int)p1.b, null);
                    g.drawImage(doubleholdnote, (int)p2.a, (int)p2.b, null);
                    break;    
                case "Circle":
                    //p2 = ActiveNote.convertCartesian(a.radius, ((CircleNote)a.note).posfinal);        //p2 is used later
                    g.drawImage(circlenote, (int)p1.a, (int)p1.b, null);
                    //g.drawImage(circlenote, (int)p2.a, (int)p2.b, null);
                    break;  
                case "Across":
                    //p2 = ActiveNote.convertCartesian(a.radius, ((AcrossNote)a.note).posfinal);        //p2 is used later
                    g.drawImage(acrossnote, (int)p1.a, (int)p1.b, null);
                    //g.drawImage(acrossnote, (int)p2.a, (int)p2.b, null);
                    break;
                case "Tap":
                    g.drawImage(tapnote, (int)p1.a, (int)p1.b, null);
                    break;
            }
        }
    }
